...
![哪里](https://github.com/luosijie/Front-end-Blog/blob/master/img/vue_resume_where.png?raw=true)

因为最近有在准备简历，就习惯性的找一找有没有现成的简历模板。结果全是付费的，丑的收**5**块，稍微讲究一点的就差不多要**10**块钱了，这让一个普通家庭怎么负担得起。
于是就产生了写一个简历模板的想法，后来就有了这个轻量的简历神器。

![vue-resume](https://github.com/luosijie/Front-end-Blog/blob/master/img/vm_resume_dribbble.png?raw=true)
...
![Logo](https://github.com/luosijie/Front-end-Blog/blob/master/img/logo_vue_resume.jpg?raw=true)

下面是Logo的设计过程

![Logo_process](https://github.com/luosijie/Front-end-Blog/blob/master/img/vm_resume_logo_maker.png?raw=true)
...
![List-item组件](https://github.com/luosijie/Front-end-Blog/blob/master/img/vue_resume_context_list.PNG?raw=true)
...
![List-item组件](https://github.com/luosijie/Front-end-Blog/blob/master/img/vue_resume_list_item.PNG?raw=true)
